        ...
        NavigationStack {
            ZStack {
                ...
                VStack {
                    ...
                    VStack(spacing: 16) {
                        HStack(spacing: 16) {
                            SegmentView(imageName: "figure.arms.open", imageColor: .blue, rightText: Text("\(vm.ans_count)"), title: "回答人数")

                            SegmentView(imageName: "figure.2.arms.open", imageColor: .red, rightText: Text("\(vm.boyfriend_count)"), title: "彼氏持ち")
                        }

                        HStack(spacing: 16) {
                            SegmentView(imageName: "character.book.closed", imageColor: .black, rightText: Text("\(vm.age_ave)"), title: "平均年齢")

                            SegmentView(imageName: "trophy.fill", imageColor: .gray, rightText: Text("\(vm.win_count)"), title: "勝利数")
                        }
                    }
...
#Preview {
    HomeView()
        .modelContainer(for: Questions.self, inMemory: true)
